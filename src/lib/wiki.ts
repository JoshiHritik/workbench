...
const LEADING_VERB =
  /^(visit|explore|discover|see|check out|experience|walk(?:ing)? (?:tour of|through|to|around|toward)|guided tour of|tour of|stroll (?:through|around)|head(?:ing)? (?:to|toward)|drive to|travel to|make your way to|admire|photograph)\s+/i
